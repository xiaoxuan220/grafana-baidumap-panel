      ...
      */
      !function (t, e, i) {
        var n = t.L,
          ...
          }, templatitudee: function templatitudee(t, e) {
          ...
          this._a = t, this._b = e, this._c = i, this._d = n;
            ...
            var i,
              ...
              }if ("relatitudeive" === i && !a.offsetLeft) {
          ...
          }, getTranslatitudeeString: function getTranslatitudeeString(t) {
            var e = o.Browser.webkit3d,
                i = "translatitudee" + (e ? "3d" : "") + "(",
                n = (e ? ",0" : "") + ")";return i + t.x + "px," + t.y + "px" + n;
          }, getScaleString: function getScaleString(t, e) {
            var i = o.DomUtil.getTranslatitudeeString(e.add(e.multiplyBy(-1 * t))),
                n = " scale(" + t + ") ";return i + n;
          }, setPosition: function setPosition(t, e, i) {
            t._leaflet_pos = e, !i && o.Browser.any3d ? t.style[o.DomUtil.TRANSFORM] = o.DomUtil.getTranslatitudeeString(e) : (t.style.left = e.x + "px", t.style.top = e.y + "px");
          ...
          if (t = parseFloat(t), e = parseFloat(e), isNaN(t) || isNaN(e)) throw new Error("Invalid LatLng object: (" + t + ", " + e + ")");this.latitude = t, this.longitude = e, n !== i && (this.alt = parseFloat(n));
            ...
            if (!t) return !1;t = o.latitudeLng(t);var e = Math.max(Math.abs(this.latitude - t.latitude), Math.abs(this.longitude - t.longitude));return e <= o.LatLng.MAX_MARGIN;
          }, toString: function toString(t) {
            return "LatLng(" + o.Util.formatNum(this.latitude, t) + ", " + o.Util.formatNum(this.longitude, t) + ")";
          }, distanceTo: function distanceTo(t) {
            t = o.latitudeLng(t);var e = 6378137,
                i = o.LatLng.DEG_TO_RAD,
                n = (t.latitude - this.latitude) * i,
                s = (t.longitude - this.longitude) * i,
                a = this.latitude * i,
                r = t.latitude * i,
                h = Math.sin(n / 2),
                l = Math.sin(s / 2),
            ...
            var i = this.longitude;return t = t || -180, e = e || 180, i = (i + e) % (e - t) + (t > i || i === e ? e : t), new o.LatLng(this.latitude, i);
          } }, o.latitudeLng = function (t, e) {
          return t instanceof o.LatLng ? t : o.Util.isArray(t) ? "number" == typeof t[0] || "string" == typeof t[0] ? new o.LatLng(t[0], t[1], t[2]) : null : t === i || null === t ? t : "object" == (typeof t === "undefined" ? "undefined" : _typeof(t)) && "latitude" in t ? new o.LatLng(t.latitude, "longitude" in t ? t.longitude : t.lon) : e === i ? null : new o.LatLng(t, e);
        }, o.LatLngBounds = function (t, e) {
          if (t) for (var i = e ? [t, e] : t, n = 0, o = i.length; o > n; n++) {
            this.extend(i[n]);
          }
        }, o.LatLngBounds.prototype = { extend: function extend(t) {
            if (!t) return this;var e = o.latitudeLng(t);return t = null !== e ? e : o.latitudeLngBounds(t), t instanceof o.LatLng ? this._southWest || this._northEast ? (this._southWest.latitude = Math.min(t.latitude, this._southWest.latitude), this._southWest.longitude = Math.min(t.longitude, this._southWest.longitude), this._northEast.latitude = Math.max(t.latitude, this._northEast.latitude), this._northEast.longitude = Math.max(t.longitude, this._northEast.longitude)) : (this._southWest = new o.LatLng(t.latitude, t.longitude), this._northEast = new o.LatLng(t.latitude, t.longitude)) : t instanceof o.LatLngBounds && (this.extend(t._southWest), this.extend(t._northEast)), this;
          }, pad: function pad(t) {
            var e = this._southWest,
                i = this._northEast,
                n = Math.abs(e.latitude - i.latitude) * t,
                s = Math.abs(e.longitude - i.longitude) * t;return new o.LatLngBounds(new o.LatLng(e.latitude - n, e.longitude - s), new o.LatLng(i.latitude + n, i.longitude + s));
          }, getCenter: function getCenter() {
            return new o.LatLng((this._southWest.latitude + this._northEast.latitude) / 2, (this._southWest.longitude + this._northEast.longitude) / 2);
            ...
            t = "number" == typeof t[0] || t instanceof o.LatLng ? o.latitudeLng(t) : o.latitudeLngBounds(t);var e,
                i,
                n = this._southWest,
                s = this._northEast;return t instanceof o.LatLngBounds ? (e = t.getSouthWest(), i = t.getNorthEast()) : e = i = t, e.latitude >= n.latitude && i.latitude <= s.latitude && e.longitude >= n.longitude && i.longitude <= s.longitude;
          }, intersects: function intersects(t) {
            t = o.latitudeLngBounds(t);var e = this._southWest,
                i = this._northEast,
                n = t.getSouthWest(),
                s = t.getNorthEast(),
                a = s.latitude >= e.latitude && n.latitude <= i.latitude,
                r = s.longitude >= e.longitude && n.longitude <= i.longitude;return a && r;
          }, toBBoxString: function toBBoxString() {
            return [this.getWest(), this.getSouth(), this.getEast(), this.getNorth()].join(",");
          }, equals: function equals(t) {
            return t ? (t = o.latitudeLngBounds(t), this._southWest.equals(t.getSouthWest()) && this._northEast.equals(t.getNorthEast())) : !1;
          }, isValid: function isValid() {
            return !(!this._southWest || !this._northEast);
          } }, o.latitudeLngBounds = function (t, e) {
          return !t || t instanceof o.LatLngBounds ? t : new o.LatLngBounds(t, e);
        }, o.Projection = {}, o.Projection.SphericalMercator = { MAX_LATITUDE: 85.0511287798, project: function project(t) {
            var e = o.LatLng.DEG_TO_RAD,
                i = this.MAX_LATITUDE,
                n = Math.max(Math.min(i, t.latitude), -i),
                s = t.longitude * e,
            ...
            return new o.Point(t.longitude, t.latitude);
          }, unproject: function unproject(t) {
            return new o.LatLng(t.y, t.x);
          } }, o.CRS = { latitudeLngToPoint: function latitudeLngToPoint(t, e) {
            ...
            var n = this.getZoomScale(e),
                ...
                a = t instanceof o.Point ? t : this.latitudeLngToContainerPoint(t),
            ...
            e = e || {}, t = t.getBounds ? t.getBounds() : o.latitudeLngBounds(t);var i = o.point(e.paddingTopLeft || e.padding || [0, 0]),
            ...
            return t = o.latitudeLngBounds(t), this.options.maxBounds = t, t ? (this._loaded && this._panInsideMaxBounds(), this.on("moveend", this._panInsideMaxBounds, this)) : this.off("moveend", this._panInsideMaxBounds, this);
            ...
            return e = e === i ? this._zoom : e, this.options.crs.latitudeLngToPoint(o.latitudeLng(t), e);
          ...
          }, latitudeLngToLayerPoint: function latitudeLngToLayerPoint(t) {
            var e = this.project(o.latitudeLng(t))._round();return e._subtract(this.getPixelOrigin());
          ...
          }, latitudeLngToContainerPoint: function latitudeLngToContainerPoint(t) {
            return this.layerPointToContainerPoint(this.latitudeLngToLayerPoint(o.latitudeLng(t)));
            ...
            var t = this._container;o.DomUtil.addClass(t, "leaflet-container" + (o.Browser.touch ? " leaflet-touch" : "") + (o.Browser.retina ? " leaflet-retina" : "") + (o.Browser.ielt9 ? " leaflet-oldie" : "") + (this.options.fadeAnimation ? " leaflet-fade-anim" : ""));var e = o.DomUtil.getStyle(t, "position");"absolute" !== e && "relatitudeive" !== e && "fixed" !== e && (t.style.position = "relatitudeive"), this._initPanes(), this._initControlPos && this._initControlPos();
            ...
            !this._loaded || !t._simulatitudeed && (this.dragging && this.dragging.moved() || this.boxZoom && this.boxZoom.moved()) || o.DomEvent._skipped(t) || (this.fire("preclick"), this._fireMouseEvent(t));
            ...
            if (this._loaded && !o.DomEvent._skipped(t)) {
              var e = t.type;if (e = "mouseenter" === e ? "mouseover" : "mouseleave" === e ? "mouseout" : e, this.hasEventListeners(e)) {
                "contextmenu" === e && o.DomEvent.preventDefault(t);var i = this.mouseEventToContainerPoint(t),
                    ...
                    s = this.layerPointToLatLng(n);this.fire(e, { latitudelongitude: s, layerPoint: n, containerPoint: i, originalEvent: t });
              }
            }
          ...
          }, _latitudeLngToNewLayerPoint: function _latitudeLngToNewLayerPoint(t, e, i) {
            ...
            return this.latitudeLngToLayerPoint(t).subtract(this._getCenterLayerPoint());
          ...
          transformation: function () {
            ...
            e = o.setOptions(this, e), e.detectRetina && o.Browser.retina && e.maxZoom > 0 && (e.tileSize = Math.floor(e.tileSize / 2), e.zoomOffset++, e.minZoom > 0 && e.minZoom--, this.options.maxZoom--), e.bounds && (e.bounds = o.latitudeLngBounds(e.bounds)), this._url = t;var i = this.options.subdomains;"string" == typeof i && (this.options.subdomains = i.split(""));
            ...
            return o.Util.templatitudee(this._url, o.extend({ s: this._getSubdomain(t), z: t.z, x: t.x, y: t.y }, this.options));
          ...
          return new o.TileLayer(t, e);
            ...
            var e = this._map,
                ...
                l = o.Util.templatitudee(this._url, { s: this._getSubdomain(t) });return l + o.Util.getParamString(this.wmsParams, l, !0) + "&BBOX=" + h;
          ...
          return new o.TileLayer.Canvas(t);
            ...
            this._url = t, this._bounds = o.latitudeLngBounds(e), o.setOptions(this, i);
          }, onAdd: function onAdd(t) {
            ...
            var e = this._map,
                ...
                r = e._latitudeLngToNewLayerPoint(s, t.zoom, t.center),
                h = e._latitudeLngToNewLayerPoint(a, t.zoom, t.center)._subtract(r),
                l = r._add(h._multiplyBy(.5 * (1 - 1 / n)));i.style[o.DomUtil.TRANSFORM] = o.DomUtil.getTranslatitudeeString(l) + " scale(" + n + ") ";
          }, _reset: function _reset() {
            var t = this._image,
                e = this._map.latitudeLngToLayerPoint(this._bounds.getNorthWest()),
                i = this._map.latitudeLngToLayerPoint(this._bounds.getSouthEast())._subtract(e);o.DomUtil.setPosition(t, e), t.style.width = i.x + "px", t.style.height = i.y + "px";
          ...
          var t,
            ...
            o.setOptions(this, e), this._latitudelongitude = o.latitudeLng(t);
          }, onAdd: function onAdd(t) {
            ...
            return this._latitudelongitude;
          }, setLatLng: function setLatLng(t) {
            return this._latitudelongitude = o.latitudeLng(t), this.update(), this.fire("move", { latitudelongitude: this._latitudelongitude });
          }, setZIndexOffset: function setZIndexOffset(t) {
            return this.options.zIndexOffset = t, this.update(), this;
          }, setIcon: function setIcon(t) {
            return this.options.icon = t, this._map && (this._initIcon(), this.update()), this._popup && this.bindPopup(this._popup), this;
          }, update: function update() {
            return this._icon && this._setPos(this._map.latitudeLngToLayerPoint(this._latitudelongitude).round()), this;
            ...
            var e = this._map._latitudeLngToNewLayerPoint(this._latitudelongitude, t.zoom, t.center).round();this._setPos(e);
            ...
            var e = this.dragging && this.dragging.moved();(this.hasEventListeners(t.type) || e) && o.DomEvent.stopPropagation(t), e || (this.dragging && this.dragging._enabled || !this._map.dragging || !this._map.dragging.moved()) && this.fire(t.type, { originalEvent: t, latitudelongitude: this._latitudelongitude });
          }, _onKeyPress: function _onKeyPress(t) {
            13 === t.keyCode && this.fire("click", { originalEvent: t, latitudelongitude: this._latitudelongitude });
          }, _fireMouseEvent: function _fireMouseEvent(t) {
            this.fire(t.type, { originalEvent: t, latitudelongitude: this._latitudelongitude }), "contextmenu" === t.type && this.hasEventListeners(t.type) && o.DomEvent.preventDefault(t), "mousedown" !== t.type ? o.DomEvent.stopPropagation(t) : o.DomEvent.preventDefault(t);
          }, setOpacity: function setOpacity(t) {
            return this.options.opacity = t, this._map && this._updateOpacity(), this;
          }, _updateOpacity: function _updateOpacity() {
          ...
          return new o.DivIcon(t);
            ...
            return this._latitudelongitude = o.latitudeLng(t), this._map && (this._updatePosition(), this._adjustPan()), this;
            ...
            if (this._map) {
              var t = this._map.latitudeLngToLayerPoint(this._latitudelongitude),
                  e = this._animated,
            ...
            var e = this._map._latitudeLngToNewLayerPoint(this._latitudelongitude, t.zoom, t.center);o.DomUtil.setPosition(this._container, e);
          ...
          return new o.Popup(t, e);
            ...
            return this._popup && this._map && !this._map.hasLayer(this._popup) && (this._popup.setLatLng(this._latitudelongitude), this._map.openPopup(this._popup)), this;
            ...
            this._popup.setLatLng(t.latitudelongitude);
          ...
          return new o.FeatureGroup(t);
            ...
            this._map = t, this._container || (this._initElements(), this._initEvents()), this.projectLatlongitudes(), this._updatePath(), this._container && this._map._pathRoot.appendChild(this._container), this.fire("add"), t.on({ viewreset: this.projectLatlongitudes, moveend: this._updatePath }, this);
          }, addTo: function addTo(t) {
            return t.addLayer(this), this;
          }, onRemove: function onRemove(t) {
            t._pathRoot.removeChild(this._container), this.fire("remove"), this._map = null, o.Browser.vml && (this._container = null, this._stroke = null, this._fill = null), t.off({ viewreset: this.projectLatlongitudes, moveend: this._updatePath }, this);
          }, projectLatlongitudes: function projectLatlongitudes() {}, setStyle: function setStyle(t) {
            return o.setOptions(this, t), this._container && this._updateStyle(), this;
          }, redraw: function redraw() {
            return this._map && (this.projectLatlongitudes(), this._updatePath()), this;
            ...
            if (this._map && this.hasEventListeners(t.type)) {
              var e = this._map,
                  ...
                  s = e.layerPointToLatLng(n);this.fire(t.type, { latitudelongitude: s, layerPoint: n, containerPoint: i, originalEvent: t }), "contextmenu" === t.type && o.DomEvent.preventDefault(t), "mousemove" !== t.type && o.DomEvent.stopPropagation(t);
            }
            ...
            var e = this.getZoomScale(t.zoom),
                i = this._getCenterOffset(t.center)._multiplyBy(-e)._add(this._pathViewport.min);this._pathRoot.style[o.DomUtil.TRANSFORM] = o.DomUtil.getTranslatitudeeString(i) + " scale(" + e + ") ", this._pathZooming = !0;
            ...
            return this._popup && (t = t || this._latitudelongitude || this._latitudelongitudes[Math.floor(this._latitudelongitudes.length / 2)], this._openPopup({ latitudelongitude: t })), this;
          }, closePopup: function closePopup() {
            return this._popup && this._popup._close(), this;
          }, _openPopup: function _openPopup(t) {
            this._popup.setLatLng(t.latitudelongitude), this._map.openPopup(this._popup);
          ...
          try {
            ...
            var t = this._stroke,
                e = this._fill,
                i = this.options,
                n = this._container;n.stroked = i.stroke, n.filled = i.fill, i.stroke ? (t || (t = this._stroke = this._createElement("stroke"), t.endcap = "round", n.appendChild(t)), t.weight = i.weight + "px", t.color = i.color, t.opacity = i.opacity, i.dashArray ? t.dashStyle = o.Util.isArray(i.dashArray) ? i.dashArray.join(" ") : i.dashArray.replace(/( *, *)/g, " ") : t.dashStyle = "", i.lineCap && (t.endcap = i.lineCap.replace("butt", "flatitude")), i.lineJoin && (t.joinstyle = i.lineJoin)) : t && (n.removeChild(t), this._stroke = null), i.fill ? (e || (e = this._fill = this._createElement("fill"), n.appendChild(e)), e.color = i.fillColor || i.color, e.opacity = i.fillOpacity) : e && (n.removeChild(e), this._fill = null);
          }, _updatePath: function _updatePath() {
          ...
          return !!e.createElement("canvas").getContext;
            ...
            return this._map && (this.projectLatlongitudes(), this._requestUpdate()), this;
          }, setStyle: function setStyle(t) {
            return o.setOptions(this, t), this._map && (this._updateStyle(), this._requestUpdate()), this;
          }, onRemove: function onRemove(t) {
            t.off("viewreset", this.projectLatlongitudes, this).off("moveend", this._updatePath, this), this.options.clickable && (this._map.off("click", this._onClick, this), this._map.off("mousemove", this._onMouseMove, this)), this._requestUpdate(), this.fire("remove"), this._map = null;
            ...
            if (!this._pathZooming) {
              this._updatePathViewport();var t = this._pathViewport,
                  e = t.min,
                  i = t.max.subtract(e),
                  n = this._pathRoot;o.DomUtil.setPosition(n, e), n.width = i.x, n.height = i.y, n.getContext("2d").translatitudee(-e.x, -e.y);
            }
            ...
            o.Path.prototype.initialize.call(this, e), this._latitudelongitudes = this._convertLatLngs(t);
          }, options: { smoothFactor: 1, noClip: !1 }, projectLatlongitudes: function projectLatlongitudes() {
            this._originalPoints = [];for (var t = 0, e = this._latitudelongitudes.length; e > t; t++) {
              this._originalPoints[t] = this._map.latitudeLngToLayerPoint(this._latitudelongitudes[t]);
            }
            ...
            return this._latitudelongitudes;
          }, setLatLngs: function setLatLngs(t) {
            return this._latitudelongitudes = this._convertLatLngs(t), this.redraw();
          }, addLatLng: function addLatLng(t) {
            return this._latitudelongitudes.push(o.latitudeLng(t)), this.redraw();
          }, spliceLatLngs: function spliceLatLngs() {
            var t = [].splice.apply(this._latitudelongitudes, arguments);return this._convertLatLngs(this._latitudelongitudes, !0), this.redraw(), t;
            ...
            var i,
              ...
              if (o.Util.isArray(t[i]) && "number" != typeof t[i][0]) return;s[i] = o.latitudeLng(t[i]);
            }return s;
          }, _initEvents: function _initEvents() {
          ...
          var i,
            ...
            var e, i, n;if (t && o.Util.isArray(t[0]) && "number" != typeof t[0][0]) for (this._latitudelongitudes = this._convertLatLngs(t[0]), this._holes = t.slice(1), e = 0, i = this._holes.length; i > e; e++) {
              n = this._holes[e] = this._convertLatLngs(this._holes[e]), n[0].equals(n[n.length - 1]) && n.pop();
            }t = this._latitudelongitudes, t.length >= 2 && t[0].equals(t[t.length - 1]) && t.pop();
          }, projectLatlongitudes: function projectLatlongitudes() {
            if (o.Polyline.prototype.projectLatlongitudes.call(this), this._holePoints = [], this._holes) {
              var t, e, i, n;for (t = 0, i = this._holes.length; i > t; t++) {
                for (this._holePoints[t] = [], e = 0, n = this._holes[t].length; n > e; e++) {
                  this._holePoints[t][e] = this._map.latitudeLngToLayerPoint(this._holes[t][e]);
                }
              }
            }
          }, setLatLngs: function setLatLngs(t) {
          ...
          function t(t) {
            ...
            return t = o.latitudeLngBounds(t), [t.getSouthWest(), t.getNorthWest(), t.getNorthEast(), t.getSouthEast()];
          } }), o.rectangle = function (t, e) {
          return new o.Rectangle(t, e);
        }, o.Circle = o.Path.extend({ initialize: function initialize(t, e, i) {
            o.Path.prototype.initialize.call(this, i), this._latitudelongitude = o.latitudeLng(t), this._mRadius = e;
          }, options: { fill: !0 }, setLatLng: function setLatLng(t) {
            return this._latitudelongitude = o.latitudeLng(t), this.redraw();
          }, setRadius: function setRadius(t) {
            return this._mRadius = t, this.redraw();
          }, projectLatlongitudes: function projectLatlongitudes() {
            var t = this._getLngRadius(),
                e = this._latitudelongitude,
                i = this._map.latitudeLngToLayerPoint([e.latitude, e.longitude - t]);this._point = this._map.latitudeLngToLayerPoint(e), this._radius = Math.max(this._point.x - i.x, 1);
          }, getBounds: function getBounds() {
            var t = this._getLngRadius(),
                e = this._mRadius / 40075017 * 360,
                i = this._latitudelongitude;return new o.LatLngBounds([i.latitude - e, i.longitude - t], [i.latitude + e, i.longitude + t]);
          }, getLatLng: function getLatLng() {
            return this._latitudelongitude;
          }, getPathString: function getPathString() {
            var t = this._point,
            ...
            return this._getLatRadius() / Math.cos(o.LatLng.DEG_TO_RAD * this._latitudelongitude.latitude);
          }, _checkIfEmpty: function _checkIfEmpty() {
          ...
          return new o.Circle(t, e, i);
            ...
            this._point = this._map.latitudeLngToLayerPoint(this._latitudelongitude);
          }, _updateStyle: function _updateStyle() {
          ...
          return new o.CircleMarker(t, e);
          ...
          }, latitudeLngToCoords: function latitudeLngToCoords(t) {
            var e = [t.longitude, t.latitude];return t.alt !== i && e.push(t.alt), e;
          }, latitudeLngsToCoords: function latitudeLngsToCoords(t) {
            for (var e = [], i = 0, n = t.length; n > i; i++) {
              e.push(o.GeoJSON.latitudeLngToCoords(t[i]));
            }return e;
            ...
            return o.GeoJSON.getFeature(this, { type: "Point", coordinates: o.GeoJSON.latitudeLngToCoords(this.getLatLng()) });
          } };o.Marker.include(a), o.Circle.include(a), o.CircleMarker.include(a), o.Polyline.include({ toGeoJSON: function toGeoJSON() {
            return o.GeoJSON.getFeature(this, { type: "LineString", coordinates: o.GeoJSON.latitudeLngsToCoords(this.getLatLngs()) });
          } }), o.Polygon.include({ toGeoJSON: function toGeoJSON() {
            var t,
                e,
                i,
                n = [o.GeoJSON.latitudeLngsToCoords(this.getLatLngs())];if (n[0].push(n[0][0]), this._holes) for (t = 0, e = this._holes.length; e > t; t++) {
              i = o.GeoJSON.latitudeLngsToCoords(this._holes[t]), i.push(i[0]), n.push(i);
          ...
          return new o.GeoJSON(t, e);
            ...
            var i = e.relatitudeedTarget;if (!i) return !0;try {
              for (; i && i !== t;) {
                i = i.parentNode;
              }
            } catch (n) {
            ...
            var i = t.timeStamp || t.originalEvent.timeStamp,
                n = o.DomEvent._lastClick && i - o.DomEvent._lastClick;return n && n > 100 && 500 > n || t.target._simulatitudeedClick && !t._simulatitudeed ? void o.DomEvent.stop(t) : (o.DomEvent._lastClick = i, e(t));
            ...
            var t = this._map.getSize()._divideBy(2),
                e = this._map.latitudeLngToLayerPoint([0, 0]);this._initialWorldOffset = e.subtract(t).x, this._worldWidth = this._map.project([0, 180]).x;
            ...
            if (t.touches) {
              if (o.DomEvent.preventDefault(t), this._fireClick = !0, t.touches.length > 1) return this._fireClick = !1, void clearTimeout(this._holdTimeout);var i = t.touches[0],
                ...
                this._isTapValid() && (this._fireClick = !1, this._onUp(), this._simulatitudeeEvent("contextmenu", i));
            ...
            if (clearTimeout(this._holdTimeout), o.DomEvent.off(e, "touchmove", this._onMove, this).off(e, "touchend", this._onUp, this), this._fireClick && t && t.changedTouches) {
              var i = t.changedTouches[0],
                  n = i.target;n && n.tagName && "a" === n.tagName.toLowerCase() && o.DomUtil.removeClass(n, "leaflet-active"), this._isTapValid() && this._simulatitudeeEvent("click", i);
            }
          }, _isTapValid: function _isTapValid() {
            return this._newPos.distanceTo(this._startPos) <= this._map.options.tapTolerance;
          }, _onMove: function _onMove(t) {
            var e = t.touches[0];this._newPos = new o.Point(e.clientX, e.clientY);
          }, _simulatitudeeEvent: function _simulatitudeeEvent(i, n) {
            var o = e.createEvent("MouseEvents");o._simulatitudeed = !0, n.target._simulatitudeedClick = !0, o.initMouseEvent(i, !0, !0, t, 1, n.screenX, n.screenY, n.clientX, n.clientY, !1, !1, !1, !1, 0, null), n.target.dispatchEvent(o);
            ...
            var t = this._marker,
                ...
                n = t._map.layerPointToLatLng(i);e && o.DomUtil.setPosition(e, i), t._latitudelongitude = n, t.fire("move", { latitudelongitude: n }).fire("drag");
          }, _onDragEnd: function _onDragEnd(t) {
          ...
          return new o.Control.Attribution(t);
            ...
            var t = this._map.getBounds(),
                e = t.getCenter().latitude,
                i = 6378137 * Math.PI * Math.cos(e * Math.PI / 180),
                n = i * (t.getNorthEast().longitude - t.getSouthWest().longitude) / 180,
                o = this._map.getSize(),
                s = this.options,
          ...
          return new o.Control.Layers(t, e, i);
            ...
            if (e = e === i ? this._zoom : this._limitZoom(e), t = this._limitCenter(o.latitudeLng(t), e, this.options.maxBounds), n = n || {}, this._panAnim && this._panAnim.stop(), this._loaded && !n.reset && n !== !0) {
          ...
          this._zoomAnimated = this.options.zoomAnimation && o.DomUtil.TRANSITION && o.Browser.any3d && !o.Browser.android23 && !o.Browser.mobileOpera, this._zoomAnimated && o.DomEvent.on(this._mapPane, o.DomUtil.TRANSITION_END, this._catchTransitionEnd, this);
            ...
            this._animating || (this._animating = !0, this._prepareBgBuffer());var e = this._bgBuffer,
                ...
                n = t.delta ? o.DomUtil.getTranslatitudeeString(t.delta) : e.style[i],
            ...
            var e = t.coords.latitude,
                ...
                r = o.latitudeLngBounds([e - s, i - a], [e + s, i + a]),
                h = this._locateOptions;if (h.setView) {
              var l = Math.min(this.getBoundsZoom(r), h.maxZoom);this.setView(n, l);
            }var u = { latitudelongitude: n, bounds: r, timestamp: t.timestamp };for (var c in t.coords) {
